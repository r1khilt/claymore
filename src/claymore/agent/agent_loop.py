...
_SYSTEM_PROMPT = (
    ...
    "computational bio analysis, (5) simulate a protocol, and (6) run a data-driven ML analysis "
    "that trains a model on a dataset the lab has discussed and tests a hypothesis against it.\n\n"
    ...
    "issue, or running a physical protocol all require explicit human approval downstream. "
    "Designing or simulating a protocol, and running a read-only ML analysis, are safe (nothing "
    "is sent and no robot runs).\n"
